...
<a href="https://explorer.shazoes.xyz/atomone-mainnet"><Icon icon="meteor-icons:search" width="35" height="35" /></a>

<!-- Endpouints -->

### Public Endpoints

<div className="endpoints">API: https://atomone-mainnet-api.shazoes.xyz</div>
<div className="endpoints">RPC: https://atomone-mainnet-rpc.shazoes.xyz</div>
<div className="endpoints">gRPC: atomone-mainnet-grpc.shazoes.xyz:12090</div>

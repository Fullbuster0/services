...
<a href="https://explorer.shazoes.xyz/shentu-mainnet"><Icon icon="meteor-icons:search" width="35" height="35" /></a>

<!-- Endpouints -->

### Public Endpoints

<div className="endpoints">API: https://shentu-mainnet-api.shazoes.xyz</div>
<div className="endpoints">RPC: https://shentu-mainnet-rpc.shazoes.xyz</div>
<div className="endpoints">gRPC: shentu-mainnet-grpc.shazoes.xyz:9090</div>

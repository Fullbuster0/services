...
<a href="https://explorer.shazoes.xyz/dhealth-mainnet"><Icon icon="meteor-icons:search" width="35" height="35" /></a>

<!-- Endpouints -->

### Public Endpoints

<div className="endpoints">API: https://dhealth-mainnet-api.shazoes.xyz</div>
<div className="endpoints">RPC: https://dhealth-mainnet-rpc.shazoes.xyz</div>
<div className="endpoints">gRPC: dhealth-mainnet-grpc.shazoes.xyz:443</div>

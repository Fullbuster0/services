...
```bash
aria2c -x 8 -s 8 https://snapshot.shazoes.xyz/testnets/snapshot-galactica.tar.lz4 && lz4 -c -d snapshot-galactica.tar.lz4 | tar -x -C $HOME/.galactica && rm snapshot-galactica.tar.lz4
```
...
SNAP_RPC="https://galactica-testnet-rpc.shazoes.xyz:443"
...
```bash
wget -O $HOME/.galactica/config/genesis.json https://files.shazoes.xyz/testnets/galactica/genesis.json
```
</TabItem>
<TabItem value="Addrbook" label="Addrbook">
```bash
wget -O $HOME/.galactica/config/addrbook.json https://files.shazoes.xyz/testnets/galactica/addrbook.json
```
</TabItem>
<TabItem value="livepeers" label="LivePeers">
<LivePeers
  rpc="https://galactica-testnet-rpc.itrocket.net"
  homeFolder=".galactica"
  binaryName="galacticad"
  maxPeers={25}
/>
</TabItem>
</Tabs>

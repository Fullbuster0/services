...
<a href="https://explorer.shazoes.xyz/cardchain-testnet"><Icon icon="meteor-icons:search" width="35" height="35" /></a>

<!-- Endpouints -->

### Public Endpoints

<div className="endpoints">API: https://cardchain-testnet-api.shazoes.xyz</div>
<div className="endpoints">RPC: https://cardchain-testnet-rpc.shazoes.xyz</div>
<div className="endpoints">gRPC: cardchain-testnet-grpc.shazoes.xyz:443</div>

...
<a href="https://explorer.shazoes.xyz/soarchain-testnet"><Icon icon="meteor-icons:search" width="35" height="35" /></a>

<!-- Endpouints -->

### Public Endpoints

<div className="endpoints">API: https://soarchain-testnet-api.shazoes.xyz</div>
<div className="endpoints">RPC: https://soarchain-testnet-rpc.shazoes.xyz</div>
<div className="endpoints">gRPC: soarchain-testnet-grpc.shazoes.xyz:443</div>

...
```bash
hippod tx slashing unjail --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```
...
```bash
hippod tx distribution withdraw-all-rewards --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

### Withdraw Rewards with Comission

```bash
hippod tx distribution withdraw-rewards $(hippod keys show wallet --bech val -a) --commission --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

### Delegate Tokens to Your Validator

```bash
hippod tx staking delegate $(hippod keys show wallet --bech val -a) 1000000000000000000ahp --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

### Redelegate Tokens to Another Validator

```bash
hippod tx staking redelegate $(hippod keys show wallet --bech val -a) <TO_VALOPER_ADDRESS> 1000000000000000000ahp --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

### Unbond Tokens from Your Validator

```bash
hippod tx staking unbond $(hippod keys show wallet --bech val -a) 1000000000000000000ahp --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

### Send Tokens to Any Wallet

```bash
hippod tx bank send wallet <TO_WALLET_ADDRESS> 1000000000000000000ahp --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```
...
```bash
hippod tx gov vote 1 yes --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```
...
```bash
hippod tx gov vote PROPOSAL_NUMBER VOTE_OPTION --from wallet --chain-id $HIPPO_TESTNET_CHAIN_ID --gas-adjustment 1.5 --gas auto --gas-prices 400000000000ahp -y
```

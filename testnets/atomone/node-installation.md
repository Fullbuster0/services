...
Chain ID: `atomone-testnet-1` | Node Version: `v4.0.0-rc1` | Custom Port: `31`
</span>
...
```bash
curl https://snapshot.shazoes.xyz/testnets/snapshot-atomone.tar.lz4 | lz4 -dc - | tar -xf - -C $HOME/.atomone
```
